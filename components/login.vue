        ...
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            ...
            <p class="text-sm mt-6 text-black">
              ...
              <nuxt-link
                to="/signup"
                class="text-gray-100 font-semibold underline ml-1"
          ...
          <form
            class="bg-slate-200 rounded-xl px-6 py-8 space-y-6 max-w-md md:ml-auto w-full"
          >
            <h3 class="text-3xl text-black font-extrabold mb-12">Sign in</h3>
            ...
            <div>
              <input
                ...
                autocomplete="email"
                required
                class="bg-gray-300 focus:bg-transparent w-full text-sm px-4 py-3.5 rounded-md outline-gray-800"
            ...
            <div>
              <button
                type="button"
                class="w-full shadow-xl py-3 px-6 text-sm font-semibold rounded-md text-black bg-gray-300 hover:bg-[#e2dbdb] focus:outline-none"
              >
                Log in
              </button>
            </div>
