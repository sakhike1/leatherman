...
<div class="font-[sans-serif]  max-w-4xl flex items-center mx-auto md:h-screen p-4">
      <div class="grid bg-gray-100 md:grid-cols-3 items-center  rounded-xl overflow-hidden">
        ...
        <form class="md:col-span-2 w-full py-6 px-6 sm:px-16">
          ...
          <div class="!mt-12">
            <button type="button" class="w-full animate-gradient py-3 px-4 tracking-wider text-sm rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none">
              Create an account
            </button>
          </div>
