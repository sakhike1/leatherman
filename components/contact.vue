...
<div class="mt-6">
            <div class="grid sm:grid-cols-2 m-40 items-start gap-14 p-8 mx-auto max-w-4xl bg-gray-50 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
                    ...
                    <div class="mt-12">
                        ...
                        <ul class="mt-4">
                            <li class="flex items-center">
                                ...
                                <a href="javascript:void(0)" class="text-[#474849] text-sm ml-4">
                ...
                <form class="ml-auo space-y-4">
                    ...
                    <button type='button'
                        class="text-white animate-gradient hover:bg-gray-600 rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
                </form>
            </div>
        </div>
