<template>
<div class="font-[sans-serif] pt-40 p-20 max-w-6xl mx-auto m-10  relative  rounded-lg py-6">
      <div class="grid lg:grid-cols-3 items-center">
        <div class="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
          ...
          <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-gray-200 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
          ...
          <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-gray-300 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
        ...
        <div class="lg:col-span-2 bg-[#c6c8c9] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
          ...
          <form>
            <div class="max-w-md mx-auto space-y-3">
              ...
              <button type='button'
                class="text-gray-800 w-full relative bg-gray-300 hover:bg-gray-200 font-semibold rounded-lg text-sm px-6 py-3 !mt-6">
...
.contact__header {
  // Specific styles for the contact header
}
