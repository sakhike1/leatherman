...
<div class="font-sans p-8 tracking-wide  max-lg:max-w-2xl mx-auto">
      ...
      <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-10 mt-6">
          ...
          <div class="flex gap-4 text-center">
            <div class="bg-gray-100 p-4 flex items-center sm:h-[380px] rounded">
              <img :src="selectedProduct.image"
                                  :alt="selectedProduct.name" class="w-full max-h-full object-contain object-top" />
            </div>
            ...
            <div class="space-y-4">
              ...
              <div class="bg-gray-100 p-4 flex items-center rounded sm:h-[182px]">
                <img src="https://readymadeui.com/images/product9.webp" alt="Product" class="w-full max-h-full object-contain object-top" />
              </div>
            </div>
          </div>
        ...
        <div class="max-w-xl">
          <p class="text-gray-800 text-3xl font-bold">{{ selectedProduct.price }}</p>
          ...
          <div class="flex flex-wrap gap-4">
            ...
            <button type="button" class="min-w-[200px] px-4 py-2.5 border border-gray-800 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded">Add to cart</button>
          </div>
        </div>
      </div>
    </div>
